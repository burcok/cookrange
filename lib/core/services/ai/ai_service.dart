...
class AIService {
  ...
  Future<String> generateCompletion({
    ...
    if (!isConfigured) {
      // Never fabricate content when unconfigured — the whole point of this
      // guard (BLK-01). Callers must catch AIFatalException and show a real
      // "AI unavailable" state, never substitute mock data.
