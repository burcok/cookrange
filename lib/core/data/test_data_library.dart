...
class TestDataLibrary {
  ...
  static WeeklyMealPlanModel weeklyPlan(String uid) {
    ...
    final days = List.generate(7, (i) {
      ...
      final totalCal =
          breakfast['cal']! + lunch['cal']! + dinner['cal']! + snack['cal']!;
  ...
  static List<FoodLog> todayFoodLogs(String uid) {
    ...
    const entries = [
      ...
      (
        ...
        18.0,
        28.0,
        'Izgara Fit Steak & Akdeniz Yeşillikleri'
      ),
      ...
      (
        ...
        38.0,
        6.0,
        'Proteinli Orman Meyveli Smoothie Bowl'
      ),
      (
        _snack2,
        'snack',
  ...
  static List<Ingredient> shoppingList() => const [
        ...
        Ingredient(
            name: 'Fıstık Ezmesi', amount: 250, unit: 'g', calories: 588),
        Ingredient(name: 'Nohut', amount: 400, unit: 'g', calories: 364),
        Ingredient(name: 'Granola', amount: 300, unit: 'g', calories: 471),
        Ingredient(
            name: 'Tam Tahıllı Ekmek', amount: 1, unit: 'somun', calories: 265),
        Ingredient(
            name: 'Biber (Karışık)', amount: 300, unit: 'g', calories: 31),
  ...
  static List<GymModel> gyms() {
    ...
    return [
      GymModel(
          ...
          description:
              'İstanbul\'un en modern fitness merkezi. 1500 m² alan, olimpik havuz ve 3 group ders salonu.',
          address: 'Bağcılar Mahallesi, Bağcılar Cad. No:12',
          city: 'İstanbul',
          district: 'Bağcılar',
          country: 'TR',
          isPublic: true,
          memberCount: 842,
          subscriptionTier: GymSubscriptionTier.premium,
          tags: ['powerlifting', 'cardio', 'pool', 'group_classes'],
          createdAt: now,
          updatedAt: now,
          latitude: 41.0389,
          longitude: 28.8559,
      ...
      GymModel(
          id: 'gym_02',
          ownerUid: 'test_owner_2',
          name: 'FitZone Kadıköy',
          description:
              'Kadıköy\'ün kalbinde 24 saat açık profesyonel spor merkezi. CrossFit ve yoga ağırlıklı program.',
          ...
          isPublic: true,
          memberCount: 637,
          subscriptionTier: GymSubscriptionTier.standard,
          tags: ['crossfit', 'yoga', 'open_24h'],
          createdAt: now,
          updatedAt: now,
          latitude: 40.9890,
          longitude: 29.0264,
      ...
      GymModel(
          id: 'gym_03',
          ownerUid: 'test_owner_3',
          name: 'Ankara Sport Club',
          description:
              'Başkentin prestijli spor kulübü. 2 olimpik yüzme havuzu, tenis kortları ve kapalı atletizm pisti.',
          address: 'Çankaya Bul. No:88',
          city: 'Ankara',
          district: 'Çankaya',
          country: 'TR',
          isPublic: true,
          memberCount: 1240,
          subscriptionTier: GymSubscriptionTier.premium,
          tags: ['pool', 'tennis', 'athletics', 'sauna'],
          createdAt: now,
          updatedAt: now,
          latitude: 39.9208,
          longitude: 32.8541,
      ...
      GymModel(
          id: 'gym_04',
          ownerUid: 'test_owner_4',
          name: 'Pulse Fitness Beşiktaş',
          description:
              'Boğaz manzaralı butik spor salonu. Özel antrenman programları ve beslenme danışmanlığı.',
          address: 'Barbaros Bul. No:67',
          city: 'İstanbul',
          district: 'Beşiktaş',
          country: 'TR',
          isPublic: true,
          memberCount: 389,
          subscriptionTier: GymSubscriptionTier.standard,
          tags: ['boutique', 'personal_training', 'nutrition'],
          createdAt: now,
          updatedAt: now,
          latitude: 41.0438,
          longitude: 29.0073),
      GymModel(
          id: 'gym_05',
          ownerUid: 'test_owner_5',
          name: 'SmartFit İzmir',
          description:
              'İzmir\'in en hızlı büyüyen fitness zinciri. AI destekli antrenman takibi ve akıllı ekipmanlar.',
          address: 'Alsancak Mah. No:23',
          city: 'İzmir',
          district: 'Konak',
          country: 'TR',
          isPublic: true,
          memberCount: 520,
          subscriptionTier: GymSubscriptionTier.premium,
          tags: ['ai_training', 'smart_equipment', 'cardio'],
          createdAt: now,
          updatedAt: now,
          latitude: 38.4189,
          longitude: 27.1287,
      ...
      GymModel(
          id: 'gym_06',
          ownerUid: 'test_owner_6',
          name: 'BodyCraft Gym Şişli',
          description:
              'Vücut geliştirme ve powerlifting odaklı profesyonel salon. 500+ makine ve serbest ağırlık alanı.',
          address: 'Halaskargazi Cad. No:102',
          city: 'İstanbul',
          district: 'Şişli',
          country: 'TR',
          isPublic: true,
          memberCount: 478,
          subscriptionTier: GymSubscriptionTier.standard,
          tags: ['bodybuilding', 'powerlifting', 'heavy_weights'],
          createdAt: now,
          updatedAt: now,
          latitude: 41.0579,
          longitude: 28.9931),
      GymModel(
          id: 'gym_07',
          ownerUid: 'test_owner_7',
          name: 'Zen Wellness Nişantaşı',
          description:
              'Pilates, yoga ve meditasyon odaklı bütünsel wellness merkezi. Sauna ve spa hizmetleri dahil.',
          address: 'Teşvikiye Cad. No:18',
          city: 'İstanbul',
          district: 'Nişantaşı',
          country: 'TR',
          isPublic: true,
          memberCount: 215,
          subscriptionTier: GymSubscriptionTier.premium,
          tags: ['yoga', 'pilates', 'meditation', 'spa', 'sauna'],
          createdAt: now,
          updatedAt: now,
          latitude: 41.0490,
          longitude: 28.9972,
      ...
      GymModel(
          id: 'gym_08',
          ownerUid: 'test_owner_8',
          name: 'Champion Bursa',
          description:
              'Bursa\'nın şampiyonlar salonu. Profesyonel boks, güreş ve mücadele sanatları ekipmanları.',
          address: 'Osmangazi Cad. No:55',
          city: 'Bursa',
          district: 'Osmangazi',
          country: 'TR',
          isPublic: true,
          memberCount: 310,
          subscriptionTier: GymSubscriptionTier.standard,
          tags: ['boxing', 'wrestling', 'martial_arts', 'mma'],
          createdAt: now,
          updatedAt: now,
          latitude: 40.1826,
          longitude: 29.0669),
  ...
  static List<CoachProfileModel> coaches() {
    ...
    return [
      CoachProfileModel(
          ...
          bio:
              'NASM sertifikalı kişisel antrenör. 10 yıllık deneyimle vücut geliştirme ve fonksiyonel antrenman uzmanlığı.',
          specializations: ['bodybuilding', 'functional_training', 'nutrition'],
          certifications: ['NASM-CPT', 'PN1'],
      ...
      CoachProfileModel(
          ...
          bio:
              'Kadın antrenmanı ve pre/post natal fitness uzmanı. ACE ve AFAA sertifikalı. Online ve yüz yüze program.',
          specializations: ['womens_fitness', 'prenatal', 'yoga', 'pilates'],
          certifications: ['ACE-CPT', 'AFAA-PFT'],
          isAcceptingClients: true,
          clientCount: 62,
          hourlyRate: 400,
          isPublic: true,
      ...
      CoachProfileModel(
          ...
          bio:
              'Eski milli güreşçi, şimdi CrossFit Level 2 antrenör. Kondisyon, güç ve dayanıklılık programları.',
          specializations: [
            'crossfit',
            'strength',
            'conditioning',
      ...
      CoachProfileModel(
          ...
          bio:
              'Beslenme bilimi mezunu sporcu diyetisyen & fitness koç. Kilo yönetimi ve spor performansı odaklı.',
          specializations: ['nutrition', 'weight_loss', 'sports_performance'],
          certifications: ['RD', 'CISSN', 'ACE-CHC'],
          isAcceptingClients: true,
          clientCount: 87,
          hourlyRate: 450,
          isPublic: true,
      ...
      CoachProfileModel(
          ...
          bio:
              'Powerlifting ve olimpik halter uzmanı. IPF milli takım antrenörü, 3 kez Türkiye şampiyonu.',
          specializations: [
            'powerlifting',
            'olympic_weightlifting',
            'strength'
          ],
          certifications: ['NSCA-CSCS', 'USAW-L2'],
      ...
      CoachProfileModel(
          uid: 'coach_06',
          displayName: 'Elif Bozkurt',
          bio:
              'Yoga ve meditasyon rehberi. Hatha, Vinyasa ve Restoratif yoga öğretmeni. Stres yönetimi programları.',
          specializations: ['yoga', 'meditation', 'mindfulness', 'flexibility'],
      ...
      CoachProfileModel(
          uid: 'coach_08',
          displayName: 'Ayşe Güven',
          bio:
              'Pilates ve rehabilitasyon uzmanı. Sakatlık sonrası geri dönüş ve postür düzeltme programları.',
          specializations: [
            'pilates',
            'rehabilitation',
            'posture',
  ...
  static const _dishData = <String, Map<String, Object>>{
    _breakfast1: {
      ...
      'desc':
          'Sulu domates, biber ve yumurtadan yapılan klasik Türk kahvaltısı.',
      'descEn':
          'Classic Turkish breakfast made with juicy tomatoes, peppers and eggs.',
      'cal': 320,
      'protein': 18,
      'carbs': 22,
      'fat': 18,
    ...
    _breakfast2: {
      ...
      'desc':
          'Ispanak, domates ve biberle hazırlanan düşük kalorili protein omlet.',
      'descEn':
          'Low-calorie protein omelette with spinach, tomatoes and peppers.',
      'cal': 280,
      'protein': 20,
      'carbs': 12,
      'fat': 16,
      'category': 'breakfast',
      'mealType': 'breakfast',
      'tags': ['low_carb', 'high_protein', 'fit'],
      'prep': 5,
      'cook': 10,
    },
    _breakfast3: {
      ...
      'desc':
          'Muz, fıstık ezmesi ve bal ile zenginleştirilmiş kremalı yulaf lapası.',
    ...
    _breakfast4: {
      ...
      'desc':
          'Tam tahıllı ekmek üzerinde avokado kreması ve haşlanmış yumurta.',
    ...
    _breakfast5: {
      ...
      'desc':
          'Ev yapımı granola, taze mevsim meyveleri ve yoğurtla hazırlanan kase.',
    ...
    _lunch1: {
      ...
      'desc':
          'Izgara bonfile, roka, cherry domates ve zeytinyağı ile Akdeniz salatası.',
      'descEn':
          'Grilled sirloin, arugula, cherry tomatoes and olive oil Mediterranean salad.',
      'cal': 520,
      'protein': 42,
      'carbs': 18,
      'fat': 28,
    ...
    _lunch2: {
      ...
      'desc':
          'Izgara somon, avokado, edamame ve kinoa ile hazırlanan omega-3 açısından zengin kase.',
      'descEn':
          'Grilled salmon, avocado, edamame and quinoa bowl rich in omega-3.',
      'cal': 480,
      'protein': 36,
      'carbs': 38,
      'fat': 18,
      'category': 'fish',
      'mealType': 'lunch',
      'tags': ['omega3', 'high_protein', 'balanced'],
      'prep': 15,
      'cook': 20,
    },
    _lunch3: {
      ...
      'desc':
          'Konserve ton balığı, fasulye, zeytin ve bol sebze ile hafif öğle salatası.',
    ...
    _lunch4: {
      ...
      'desc':
          'Közlenmiş sebzeler, nohut, tahini sos ve taze otlar ile doyurucu bowl.',
      'descEn':
          'Roasted vegetables, chickpeas, tahini sauce and fresh herbs filling bowl.',
      'cal': 380,
      'protein': 18,
      'carbs': 48,
      'fat': 12,
      'category': 'vegetarian',
      'mealType': 'lunch',
      'tags': ['vegan', 'fiber', 'plant_protein'],
      'prep': 10,
      'cook': 20,
    },
    _lunch5: {
      ...
      'desc':
          'Marine edilmiş ızgara tavuk göğsü ve karışık yeşil yaprak salatası.',
    ...
    _dinner1: {
      ...
      'desc':
          'Limonlu ızgara somon filetosu, buharda pişirilmiş brokoli ve havuç.',
      'descEn':
          'Lemon grilled salmon fillet with steamed broccoli and carrots.',
      'cal': 480,
      'protein': 40,
      'carbs': 16,
      'fat': 22,
    ...
    _dinner2: {
      ...
      'desc':
          'Dana etiyle pişirilmiş geleneksel Türk nohut yemeği, yanında pilav.',
      'descEn':
          'Traditional Turkish chickpea stew cooked with beef, served with rice.',
      'cal': 560,
      'protein': 36,
      'carbs': 48,
      'fat': 18,
    ...
    _dinner3: {
      ...
      'desc':
          'Ev yapımı bolonez sos ve tam tahıllı makarna ile klasik İtalyan tarifi.',
      'descEn':
          'Classic Italian recipe with homemade bolognese sauce and whole grain pasta.',
      'cal': 620,
      'protein': 34,
      'carbs': 64,
      'fat': 22,
    ...
    _dinner4: {
      ...
      'desc':
          'Baharatlı köfte ve tereyağlı domatesli bulgur pilavı klasik Türk yemeği.',
      'descEn':
          'Spiced meatballs with buttery tomato bulgur pilaf classic Turkish dish.',
      'cal': 580,
      'protein': 38,
      'carbs': 48,
      'fat': 26,
    ...
    _dinner5: {
      ...
      'desc':
          'Aromalı dana bonfile, fırınlanmış patates ve ratatouille yanında.',
      'descEn':
          'Aromatic beef tenderloin, roasted potatoes and ratatouille side.',
      'cal': 640,
      'protein': 44,
      'carbs': 42,
      'fat': 28,
    ...
    _snack1: {
      ...
      'desc':
          'Protein tozu, orman meyveleri, muz ve granola ile doyurucu smoothie bowl.',
      'descEn':
          'Filling smoothie bowl with protein powder, forest berries, banana and granola.',
      'cal': 280,
      'protein': 18,
      'carbs': 38,
      'fat': 6,
    ...
    _snack2: {
      ...
      'desc':
          'Yulaf ezmesi, çilek, ahududu ve bal ile antioksidan açısından zengin kase.',
      'descEn':
          'Antioxidant-rich bowl with oatmeal, strawberries, raspberries and honey.',
      'cal': 320,
      'protein': 10,
      'carbs': 54,
      'fat': 8,
      ...
      for (var i = 0; i < rows.length; i++)
        {
          ...
          'created_at': Timestamp.fromDate(
              base.subtract(Duration(days: rows[i][4] as int))),
        },
    ];
  }
}
