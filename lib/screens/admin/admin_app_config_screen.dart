    ...
    return ListView(
      ...
      children: [
        ...
        _Section(
          ...
          t: t,
          children: [
            _field(_aiTextModelCtrl,
                l10n.translate('admin.appconfig.ai_text_model')),
            _field(_aiVisionModelCtrl,
                l10n.translate('admin.appconfig.ai_vision_model')),
            _numField(_aiMaxTokensCtrl,
                l10n.translate('admin.appconfig.ai_max_tokens')),
            _numField(_aiTemperatureCtrl,
                l10n.translate('admin.appconfig.ai_temperature'),
                decimal: true),
            _numField(
                _aiTimeoutCtrl, l10n.translate('admin.appconfig.ai_timeout')),
            _numField(_aiFreeLimitCtrl,
        ...
        _Section(
          ...
          t: t,
          children: [
            _field(_verMinAndroidCtrl,
                l10n.translate('admin.appconfig.ver_min_android')),
            _field(
                _verMinIosCtrl, l10n.translate('admin.appconfig.ver_min_ios')),
            _field(_verLatestAndroidCtrl,
                l10n.translate('admin.appconfig.ver_latest_android')),
            _field(_verLatestIosCtrl,
                l10n.translate('admin.appconfig.ver_latest_ios')),
            _switch(
                l10n.translate('admin.appconfig.ver_force'),
                _verForceUpdate,
                (v) => setState(() => _verForceUpdate = v),
                palette,
                t),
            _field(_verAndroidUrlCtrl,
                l10n.translate('admin.appconfig.ver_android_url')),
            _field(
                _verIosUrlCtrl, l10n.translate('admin.appconfig.ver_ios_url')),
        ...
        _Section(
          ...
          children: [
            ...
            _field(
                _maintMsgEnCtrl, l10n.translate('admin.appconfig.message_en')),
            _field(
                _maintMsgTrCtrl, l10n.translate('admin.appconfig.message_tr')),
          ],
        ),
        // ── Announcement ──────────────────────────────────────────
        _Section(
          ...
          children: [
            ...
            _switch(
                l10n.translate('admin.appconfig.ann_dismissible'),
                _annDismissible,
                (v) => setState(() => _annDismissible = v),
                palette,
                t),
