...
/// Shown after submitting a gym application (and from GymDashboardScreen
/// when the application status is [GymApplicationStatus.pending]).
class GymApplicationPendingScreen extends StatelessWidget {
  final bool showBackButton;
  final String? reviewerNotes;
  final GymApplicationStatus status;

  const GymApplicationPendingScreen({
    super.key,
    this.showBackButton = true,
    this.reviewerNotes,
    this.status = GymApplicationStatus.pending,
  });
            ...
            children: [
              ...
              if (reviewerNotes != null && reviewerNotes!.isNotEmpty) ...[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        l10n.translate('gym.app_reviewer_notes'),
              ...
              if (!isRejected) ...[
                _InfoRow(
                  ...
                  text: l10n.translate('gym.app_pending_step1'),
                  palette: palette,
                  t: t,
                ),
                const SizedBox(height: 12),
                _InfoRow(
                  ...
                  color: primary,
                  text: l10n.translate('gym.app_pending_step2'),
                  palette: palette,
                  t: t,
                ),
                const SizedBox(height: 12),
                _InfoRow(
                  ...
                  color: primary,
                  text: l10n.translate('gym.app_pending_step3'),
                  palette: palette,
                  t: t,
                ),
              ],
              if (isRejected) ...[
                ...
                SizedBox(
                  width: double.infinity,
                  child: AppButton(
                    label: l10n.translate('gym.app_reapply'),
                    onPressed: () => Navigator.of(context).pop(),
