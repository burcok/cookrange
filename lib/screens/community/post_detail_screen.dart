...
class _PostDetailScreenState extends State<PostDetailScreen> {
              ...
              children: [
                  ...
                  children: [
                    ...
                    PopupMenuButton<String>(
                      ...
                      onSelected: (val) async {
                        ...
                        if (val == 'delete')
                          unawaited(_onDeleteComment(comment.id));
                        if (val == 'report') {
                ...
                if (isEditing)
                  ...
                  Text(
                    comment.content,
                    style:
                        textStyles.bodyM.copyWith(color: palette.textPrimary),
                  ),
  ...
  void _showReportDialog(BuildContext context, {String? commentId}) {
    ...
    final reasons = [
      ...
      (
        'misinformation',
        l10n.translate('community.report.reason_misinformation')
      ),
